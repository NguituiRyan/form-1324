...
const media = (x,animated=false,compact=false) => `<div class="exercise-media ${compact?"exercise-media--compact":""}"><img src="${MEDIA}${animated?x.gif:x.image}" alt="${title(x.name)} demonstration" loading="${compact?"lazy":"eager"}">${compact?"":"<small>© Gym visual</small>"}</div>`;
const heroMedia = `<div class="exercise-media"><img src="${MEDIA}videos/0025-EIeI8Vf.gif" alt="Barbell bench press demonstration"><small>© Gym visual</small></div>`;

function shell() {
  root.innerHTML = `
  <header class="site-header"><a class="brand" href="#top"><span>NGUITUI</span><i>/</i><b>FITNESS</b></a><nav><a href="#plans">Plans</a><a href="#library">Exercises</a><a href="#builder">Build your own</a></nav><a class="header-cta" href="/routine/">My routine <span>↗</span></a></header>
  <section class="hero" id="top"><div class="hero-copy"><p class="kicker"><span></span> TRAIN WITH INTENT</p><h1>Build a body<br>that <em>works.</em></h1><p class="hero-sub">Proven plans when you want direction. A deep exercise library when you want control. No noise—just your next good session.</p><div class="hero-actions"><a href="#plans" class="button button--primary">Find my plan <span>→</span></a><a href="#builder" class="text-link">Build my own <span>↗</span></a></div><div class="hero-stats"><div><strong>1,324</strong><span>exercises</span></div><div><strong>10</strong><span>body areas</span></div><div><strong>30+</strong><span>equipment types</span></div></div></div><div class="hero-visual"><div class="hero-orbit hero-orbit--one"></div><div class="hero-orbit hero-orbit--two"></div>${heroMedia}<div class="floating-card floating-card--top"><small>TODAY / PUSH</small><strong>6 movements</strong><span>45 min · moderate</span></div><div class="floating-card floating-card--bottom"><div class="pulse-dot"></div><span><small>WEEKLY RHYTHM</small><strong>3 of 4 sessions</strong></span></div></div></section><div class="motion-ribbon"><div>NGUITUI FITNESS <i>✦</i> TRAIN SMARTER <i>✦</i> MOVE BETTER <i>✦</i> 1,324 EXERCISES <i>✦</i> NGUITUI FITNESS <i>✦</i></div></div>
  <section class="plans-section reveal" id="plans"><div class="section-heading"><div><p class="kicker"><span></span> READY-MADE PROGRAMS</p><h2>Pick your path.</h2></div><p>Clear schedules, smart exercise selection, and room to progress. Choose one and start today.</p></div><div class="plans-grid" id="plans-grid"></div></section>
  <section class="today-section reveal" id="today"><div class="section-heading section-heading--light"><div><p class="kicker"><span></span> YOUR TRAINING</p><h2 id="active-name">Nothing scheduled yet.</h2></div></div><div id="active-list" class="empty-training"><span>↗</span><p>Choose a ready-made plan above or build your own below. Your sessions will live here.</p></div></section>
  ...
  <section class="builder-section reveal" id="builder"><div class="builder-copy"><p class="kicker"><span></span> YOUR RULES</p><h2>Build your own.</h2><p>Pick movements from the library, arrange a focused session, and save it on this device.</p><ol><li><span>01</span> Search the exercise library</li><li><span>02</span> Tap + to add movements</li><li><span>03</span> Name it and save your plan</li></ol></div><div class="builder-board"><div class="builder-top"><label>PLAN NAME<input id="plan-name" value="My training week"></label><span id="count">0 / 12 MOVEMENTS</span></div><div class="builder-list" id="builder-list"></div><button class="save-plan" id="save">Save my plan <span>→</span></button></div></section>
  <footer><a class="brand brand--footer" href="#top"><span>NGUITUI</span><i>/</i><b>FITNESS</b></a><p>Train with intent. Progress with patience.</p><div>Exercise data and demonstrations from <a href="https://github.com/hasaneyldrm/exercises-dataset">hasaneyldrm/exercises-dataset</a>.<br>Exercise media © <a href="https://gymvisual.com/">Gym visual</a>. Used with visible attribution.</div></footer><nav class="mobile-dock"><a href="#top"><b>⌂</b><span>Home</span></a><a href="#plans"><b>◫</b><span>Plans</span></a><a href="#library"><b>⌕</b><span>Explore</span></a><a href="/routine/"><b>↗</b><span>Routine</span></a></nav><div id="modal"></div>`;
}
